...
import { Trophy, Target, Users, TrendingUp, Calendar, Building2 } from 'lucide-react'
...
const PerformanceView = ({ year = 2025 }: PerformanceViewProps) => {
    const {
        agentPerformance,
        branchPerformance,
        topAgents,
    ...
    if (agentPerformance.length === 0) {
        return (
            <div className="glass-card" style={{ textAlign: 'center', padding: '3rem' }}>
                ...
                <h3 style={{ marginBottom: '0.5rem' }}>Brak danych wydajności</h3>
                <p style={{ color: 'var(--text-muted)' }}>
                    Uruchom skrypt importu danych:<br />
                    <code style={{ background: 'rgba(0,0,0,0.3)', padding: '0.5rem', borderRadius: '4px', display: 'inline-block', marginTop: '0.5rem' }}>
                        node scripts/importPerformanceData.cjs
                    </code>
                </p>
            </div>
        )
            ...
            <div className="glass-card">
                <h3 style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    {selectedBranch && (
                        <span style={{
                            fontSize: '0.875rem',
                            background: BRANCH_COLORS[selectedBranch],
